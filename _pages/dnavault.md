...
<div class="swiper dnavault-swiper" style="margin: 2em 0; padding-bottom: 3em;">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <img src="/assets/images/dnavault_welcome.png?v=20260430" alt="Welcome" style="border-radius:20px; width:100%; max-width:280px; display:block; margin:0 auto; box-shadow: 0 8px 30px rgba(0,0,0,0.3);">
      <p style="text-align:center; margin-top:1em;"><strong>DNAVault</strong><br><small>Your genome. Your privacy. Your phone.</small></p>
    </div>
    <div class="swiper-slide">
      <img src="/assets/images/dnavault_home.png?v=20260430" alt="Your Genetic Data" style="border-radius:20px; width:100%; max-width:280px; display:block; margin:0 auto; box-shadow: 0 8px 30px rgba(0,0,0,0.3);">
    ...
    <div class="swiper-slide">
      <img src="/assets/images/dnavault_kinship.png?v=20260430" alt="Kinship Analysis" style="border-radius:20px; width:100%; max-width:280px; display:block; margin:0 auto; box-shadow: 0 8px 30px rgba(0,0,0,0.3);">
    ...
    <div class="swiper-slide">
      <img src="/assets/images/dnavault_health.png?v=20260430" alt="Health Insights" style="border-radius:20px; width:100%; max-width:280px; display:block; margin:0 auto; box-shadow: 0 8px 30px rgba(0,0,0,0.3);">
    ...
    <div class="swiper-slide">
      <img src="/assets/images/dnavault_ask.png?v=20260430" alt="Ask Your Genome" style="border-radius:20px; width:100%; max-width:280px; display:block; margin:0 auto; box-shadow: 0 8px 30px rgba(0,0,0,0.3);">
